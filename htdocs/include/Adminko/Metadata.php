...
class Metadata
{
    public static $objects = array(
        ...
        'news_tag' => array(
            ...
            'internal' => true,
            'fields' => array(
                'news_id' => array( 'title' => 'Новость', 'type' => 'table', 'table' => 'news', 'errors' => array('require') ),
                'tag_id' => array( 'title' => 'Тег', 'type' => 'table', 'table' => 'tag', 'errors' => array('require') ),
            ),
        ),
        ...
        'portfolio' => array(
            ...
            'fields' => array(
                ...
                'portfolio_title' => array( 'title' => 'Название', 'type' => 'string', 'show' => 1, 'main' => 1, 'errors' => array('require') ),
