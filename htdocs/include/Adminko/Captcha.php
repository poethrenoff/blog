...
class Captcha
{
    ...
    public $backgroundColor = array(250, 250, 250);
     ...
     */
    public $fonts = array(
        'comic' => array('spacing' => 4, 'minSize' => 30, 'maxSize' => 40, 'font' => 'comic.ttf'),
        'courbi' => array('spacing' => 2, 'minSize' => 30, 'maxSize' => 40, 'font' => 'courbi.ttf'),
        'arial' => array('spacing' => 4, 'minSize' => 30, 'maxSize' => 40, 'font' => 'arial.ttf'),
        'times' => array('spacing' => 2, 'minSize' => 30, 'maxSize' => 40, 'font' => 'times.ttf'),
    );
    ...
    public function createImage()
    {
        ...
        /** Text insertion */
        $text = rand(1000, 9999); // $this->getCaptchaText();
    ...
    protected function writeText($text, $fontcfg = array())
    {
        ...
        $y = round(($this->height * 0.8) * $this->scale);
        $length = strlen($text);
        for ($i = 0; $i < $length; $i++) {
